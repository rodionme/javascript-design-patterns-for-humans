...
(обычно более двух аргументов считается слишком большим), используйте единственный аргумент в виде объекта вместо 
нескольких аргументов других типов. 
Это позволяет достичь 2 цели:
...
Теперь `WildDog` может вступить в действие благодаря `WildDogAdapter`.
...
// Сделаем такую цепочку: bank -> paypal -> bitcoin
//
// Приоритет у банка
...
// Сохранение состояния в: Это первое предложение. Это второе.
